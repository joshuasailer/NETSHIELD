...
|---|---|---:|---|---|
| [`active_blacklist_ipv4.txt`](active_blacklist_ipv4.txt) | Aktive Bedrohungen (30T + Conf≥50) | **2,650,473**                                                                                                                                                                                                             | 8x täglich | **OPNsense / Firewall** |
| [`combined_threat_blacklist_ipv4.txt`](combined_threat_blacklist_ipv4.txt) | Alle IPs (180 Tage) | **3,849,720**                                                                                                                                                                                                             | 8x täglich | Audit / SIEM |
| [`blacklist_confidence40_ipv4.txt`](blacklist_confidence40_ipv4.txt) | Hohe Konfidenz (Score ≥50) | **2,650,473**                                                                                                                                                                                                             | 8x täglich | Strenge Umgebungen |
| [`watchlist_confidence20to39_ipv4.txt`](watchlist_confidence20to39_ipv4.txt) | Watchlist (Score 25–49) | **376,761**                                                                                                                                                                                                             | 8x täglich | Monitoring |
